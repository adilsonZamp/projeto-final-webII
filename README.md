...
A ideia é o dono poder criar várias lojas, vários funcionários, registrar dados de vendas de cada unidade, folha salaria, contas, entre outras coisas.
Então o sistema compila esses dados e mostra com relatórios e dashboards, com o passar do tempo da para implementar mais módulos, como em ERPs consolidados no mercado.
